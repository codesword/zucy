...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "An MVC framework based on Rack"
  spec.description   = "An MVC framework based on Rack"
  spec.homepage      = "https://github.com/andela-iokonkwo/zucy"
  spec.license       = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    raise "RubyGems 2.0 or newer is
      required to protect against public gem pushes."
  end
